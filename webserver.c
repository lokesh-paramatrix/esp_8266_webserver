...
//String ssid ="First Floor ke Parinde";

//String password="101srLLDDb";
...
String server = "192.168.43.211"; // www.example.com

String uri = "/led_app/?led=on";// our example is /esppost.php
...
esp.println("AT+CIPSTART=\"TCP\",\"" + server + "\",9001");//start a TCP connection.
